...
function CalendarDayButton({
  ...
  return (
    ...
    >
      ...
      {/** 家計: 日々の入出金額をここに置く。未実装の間は枠として確保。 */}
      <div
        className="flex min-h-0 flex-1 items-center justify-center px-0.5 text-center text-[0.65rem] leading-tight text-inherit opacity-40"
