 ...
 */
export function dummyBudgetId(year: number, month: number, day: number): number {
  return year * 10 + month * 100 + day;
}

export const DUMMY_CATEGORY_MASTER: HomeBudgetCategory[] = [
...
export function dummyCategory(): HomeBudgetCategory[] {
